...
/// Compiler    :       MinGW GCC 4.7.2(Minimalist GNU for Windows)\n
///
...
///
/// 2. Bruno Van de Valde, Student, University of Antwerp, Belgium
...
int main()
{
    ...
    */
    ...
    sf::Image m_icon;
    m_icon.loadFromFile("Resources/Images/BEATSATION-MUSIX.png");
    ...
    */
    ...
    m_info2->setText("E-mail : koushtav@fleptic.eu");
    m_info2->setTextSize(16.f);
    m_info2->setPosition(130.f, 80.f);
